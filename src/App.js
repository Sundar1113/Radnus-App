...
function App() {
  ...
  useEffect(() => {
    document.title = "Radnus Weather App";
  }, []);
  ...
  return (
    <div className="app">
      <h1 className="heading">Welcome to Radnus Weather App</h1>
      ...
      <footer className="footer">
        <h4>&copy; {new Date().getFullYear()} Weather app Designed By Sundar. All rights reserved.</h4>
      </footer>
    </div>
  );
}
